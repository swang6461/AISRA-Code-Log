...
class RobotComms:
    ...
    def connect_arduinos(self):
        ...
        for port in ports:
            try:
                ...
                # Wait for the Arduino to reboot and print its setup() messages
                time.sleep(2)

                # Read EVERY line it printed during those 2 seconds
                lines = s.readlines()
                found = False
                ...
                # If it's not one of our Arduinos, close the port
                if not found:
                    s.close()
        ...
        if not self.ard1 or not self.ard2:
            ...
            print("Please check your USB cables and ensure both are flashed correctly.")
    ...
    def send_motion(self, steps_0, steps_1, steps_2, steps_3, time_ms, speed_steps_0):
        ...
        if self.ard2 and steps_0 != 0:
            ...
            deg_0 = abs(steps_0 * (360.0 / (6400 * 1.6)))
